...
const Contact = () => {
  return (
    <section className="min-h-screen bg-black text-white pt-24 px-6">
      <h2 className="text-yellow-400 text-3xl font-bold mb-8 text-center">Want to hire or get in touch? Contact Me</h2>
      <p className="text-white-400 text-1xl font-bold mb-8 text-center">If you're looking for an intern or a full-time employee, you can email me by clicking the link below or connect with me on Linkedin or fill out the form! Whatever works the best for you</p> 
      {/* Social Links */}
